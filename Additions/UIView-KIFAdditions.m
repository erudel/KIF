...
{
    return [self isKindOfClass:NSClassFromString(@"UINavigationItemView")] ||
    [self isKindOfClass:NSClassFromString(@"_UINavigationBarBackIndicatorView")] ||
    [self isKindOfClass:NSClassFromString(@"_UIModernBarButton")];
}
